...
extension Quotient: Hashable, CustomStringConvertible {
    static func == (lhs: Quotient, rhs: Quotient) -> Bool {
...
extension Quotient: Expression {
    var eType: ExpressionType { .binaryOperation(bType: .quotient, sType: ScalarType(combining: arg1.eType.sType, arg2.eType.sType)) }
